/***********************************************************************
 * InstagramDialog.java:  Handles Instagram dialog pop-up during
 *                        authentication
 *
...
public class InstagramDialog extends Dialog {
	...
	private static final float[] DIMENSIONS_PORTRAIT = { 330, 245 };
	...
	private void setUpTitle() {
		...
		mTitle.setBackgroundColor(Color.parseColor("#517FA4"));
	...
	private class OAuthWebViewClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			...
			if (url.startsWith(InstagramManager.mCallbackUrl)) {
